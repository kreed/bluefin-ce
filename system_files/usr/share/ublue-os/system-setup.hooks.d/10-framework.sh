...
# FRAMEWORK 13 (AMD Ryzen 7040 Series) FIXES
if [[ "$VEN_ID" == "Framework" && "$SYS_ID" == "Laptop 13 (AMD Ryzen 7040Series)" && "$CPU_VENDOR" == "AuthenticAMD" ]]; then
    echo "Framework Laptop 13 AMD Ryzen 7040 detected"
